...
<html>
	<body>
		...
		<div align=center></center>
			...
			<a href="file://E|/alt/EatSelect.php"><p style="float: left; font-size: 12pt; text-align: center; width: 18.5%; margin-right: 1%; margin-bottom: 0.1em;"><input type="image" img src = "file://E|/ProgramImageDirectory/Actions/Male/Eat.jpg" onclick = "myFunctionW()" alt="Submit" style ="width: 100%">Eat</p></a> 	
			...
			<a href="file://E|/alt/WalkToSelect.php"><p style="float: left; font-size: 12pt; text-align: center; width: 18.5%; margin-right: 1%; margin-bottom: 0.1em;"><input type="image" img src = "file://E|/ProgramImageDirectory/Actions/Male/Walk.jpg" onclick = "myFunctionI()" alt="Submit" style="width: 100%">Walk</p></a>
			<a href="file://E|/alt/DrinkSelect.php"><p style="float: left; font-size: 12pt; text-align: center; width: 18.5%; margin-right: 1%; margin-bottom: 0.1em;"><input type="image" img src = "file://E|/ProgramImageDirectory/Actions/Male/Drink.jpg" onclick = "myFunctionO()" alt="Submit" style="width: 100%">Drink</p></a>
			<a href="file://E|/alt/BuySelect.php"><p style="float: left; font-size: 12pt; text-align: center; width: 18.5%; margin-right: 1%; margin-bottom: 0.1em;"><input type="image" img src = "file://E|/ProgramImageDirectory/Actions/Male/Buy.jpg" onclick = "myFunctionP()" alt="Submit" style="width: 100%">Buy</p><p style="clear: both;"></a> 
